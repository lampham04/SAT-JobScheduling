...
SOLUTION_DIR   = BASE_DIR / ".." / "solutions_gurobi" / "50-L"

INSTANCE_NAME_FILE = BASE_DIR / ".." / "filenames" / "50.txt"
RESULT_CSV = BASE_DIR / ".." / "results" / "L" /"results_GUROBI_L.csv"
...
def main():
    ...
    for fname in filenames:
        ...
        proc = subprocess.Popen(
            [
                sys.executable,
                str(BASE_DIR / "run_one_instance_gurobi.py"),
                str(instance_path),
                str(sol_file)
            ]
        )
    ...
    print("Experiment finished (resume-safe)")
